  ...
  if (!current) {
    return (
      <div className="p-4 sm:p-8 max-w-3xl mx-auto text-center py-20">
        <CheckCircle2 className="w-9 h-9 mx-auto mb-3 text-green-400" strokeWidth={1.5} />
    ...
    <div className="p-4 sm:p-8 max-w-3xl mx-auto">
      ...
      {checked !== null && (
        <div className={`rounded-xl p-3 mb-4 text-center ${
          ...
          {checked ? (
            <p className="text-green-400 font-semibold inline-flex items-center gap-1.5"><Check className="w-4 h-4" strokeWidth={2.5} /> Правильно!</p>
          ) : (
            <>
              <p className="text-red-400 font-semibold mb-1 inline-flex items-center gap-1.5"><X className="w-4 h-4" strokeWidth={2.5} /> Неправильно</p>
