  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      ...
      <div className="flex flex-col gap-3 w-full max-w-xs">
        ...
        <Link
          href="/lessons"
          className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-card border border-border text-muted-foreground hover:text-white hover:border-[#475569] text-sm font-medium transition-all"
        >
